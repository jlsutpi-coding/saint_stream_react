  ...
  return (
    <>
      <div className="relative py-10 pl-[75px] border border-[#ffffff1a]   ">
        ...
        <div
          className="absolute z-20 h-64 flex items-center bg-[linear-gradient(269.96deg,#0D0C0F_18.88%,rgba(13,12,15,0)_99.97%,#0D0C0F_99.97%)]
 bottom-10 py-[72px] px-5 right-0 "
        >
          <MdOutlineKeyboardArrowRight
